...
def getTrainingMatrix(trainingfilename):
	'''
...
def calculateEmotionalProbabilities(trainingMatrix, blockProbabilities):
...
def main():
	...
	trainingfile = "Docs/trainingPDF.csv"
	...
	weightOfEmotions, clustersForEmotions, blockProbabilities = pdfFromClusters(dumpLabelsFile)
	for blockProbability in blockProbabilities:
		sentimentScores = calculateEmotionalProbabilities(trainingMatrix, blockProbability)
