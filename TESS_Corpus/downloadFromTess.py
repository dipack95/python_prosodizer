...
def main():
	...
	for tempEmote in keys:
		i = 1
		while i < 200:
			url = "https://tspace.library.utoronto.ca/bitstream/1807/" + str(oldEmotions[tempEmote]) + "/" + str((i + 1)) + "/OAF_" + str(words[i]) + "_" + str(tempEmote)  + ".wav"
			fileName = "OAF_" + str(words[i]) + "_" + str(tempEmote)  + ".wav"
	...
	for tempEmote in keys:
		i = 1
		while i < 200:
			url = "https://tspace.library.utoronto.ca/bitstream/1807/" + str(oldEmotions[tempEmote]) + "/" + str((i + 1)) + "/YAF_" + str(words[i]) + "_" + str(tempEmote)  + ".wav"
