...
def main():
    inputFile = []
    inputFile += ["/home/dipack/College/Fourth_Year/Final_Year_Project/sounds/training_dataset/angry/training_angry_10.wav"]
    ...
    for tempInFile in inputFile:
        ...
        filterBanks = get_filterbanks(nfilt = 26, samplerate=8000)
